...
TODO:
Implement PIT functions with name-tree
- predicate_PitEntry_similar_Interest()
- Pit::insert()
  name_tree insert function
- Pit::findAllDataMatches()
  call the lookup function on the full name
  follow the parent pointers to get all the prefixes
- Pit::remove
